...
#print(get_location("Российская Федерация, Красноярский край, г. Красноярск, ул. Калинина, д. 77, стр. 9, пом. 3"))
