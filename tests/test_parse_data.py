...
def test_get_type():
    ...
    assert get_type('Нежилое здание площадью 27,2 кв. м., кадастровый номер: 21:09:200101:647, расположенное по адресу: Чувашская Республика, Вурнарский район, д. Кумаши, ул. Молодежная, д. 7, пом. 1') == "здание"
